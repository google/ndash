...
#include "mp4/offset_byte_queue.h"
#include "mp4/track_run_iterator.h"
...
class MEDIA_EXPORT MP4StreamParser : public StreamParser {
 ...
 private:
  ...
  bool ParseSidx(mp4::BoxReader* reader, uint64_t initial_pos);

  int64_t ScaleLargeTimestamp(int64_t timestamp,
                              int64_t multiplier,
                              int64_t divisor);
