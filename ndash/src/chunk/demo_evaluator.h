...
#ifndef NDASH_CHUNK_DEMO_EVALUATOR_H_
#define NDASH_CHUNK_DEMO_EVALUATOR_H_
...
class DemoEvaluator : public FormatEvaluatorInterface {
 public:
  DemoEvaluator();
  ~DemoEvaluator() override;
...
#endif  // NDASH_CHUNK_DEMO_EVALUATOR_H_
